...
enum
{
    ...
    NODE_TYPE_STATEMENT_ELSE,//11
    NODE_TYPE_STATEMENT_WHILE,//    12
    NODE_TYPE_STATEMENT_DO_WHILE,//13
    NODE_TYPE_STATEMENT_FOR,//14
    NODE_TYPE_STATEMENT_BREAK,//15
    NODE_TYPE_STATEMENT_CONTINUE,//16
    NODE_TYPE_STATEMENT_SWITCH,//17
    NODE_TYPE_STATEMENT_CASE,//18
    NODE_TYPE_STATEMENT_DEFAULT,//19
    NODE_TYPE_STATEMENT_GOTO,//20
